...
const heartIcon = document.querySelector('.top-bar .material-icons:first-child');

// Attach a click event listener
heartIcon.addEventListener('click', function() {
    // Toggle the heart icon color
    if (heartIcon.innerText === 'favorite_border') {
        heartIcon.innerText = 'favorite'; // Change the heart to red
        // You might also consider adding a class and handling the color via CSS
        // heartIcon.classList.add('red-heart');
    } else {
        heartIcon.innerText = 'favorite_border'; // Change it back to its original state
